...
精确变量名、Secrets 管理入口、workflow 示例及预览/历史 Windows 构建的区别见 [发布配置指南](../../observability/RELEASE.md#github-actions-配置与维护)。本轮只核对配置存在和工作流接线，没有执行新的 CI 发布，也没有读取 Secret 明文验证有效性。
