...
已发布，待原机验收；[GitHub 状态回执](https://github.com/heypandax/pairlet/issues/385#issuecomment-5744961350) 已写回并核对。完整构建、生产部署和剩余验收范围见 [2.1.1 发布记录](RELEASE-2.1.1.md)。上文未推送／未发布等描述保留为当时的实施快照。
