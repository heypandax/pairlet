...
cask "cc-pocket" do
  ...
  on_arm do
    sha256 :no_check # TODO(1.1.7): paste the macos-arm64 tarball sha256 from the 1.1.7 release CI run
  end
  on_intel do
    sha256 :no_check # TODO(1.1.7): paste the macos-x86_64 tarball sha256 from the 1.1.7 release CI run
  end
